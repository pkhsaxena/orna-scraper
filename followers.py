...
def parse(content) -> bool:
    ...
    followers = soup.find_all('a', class_='codex-entries-entry')

    for fol in followers:
        details = {}
        details['name'] = fol.contents[1].contents[0]
        details['tier'] = fol.contents[2].contents[0].replace('\u2605', '')
        details['img'] = fol.contents[0].contents[0]['src']
        tag = {}
        tag[fol['href'].split("/")[-2]] = details
...
if __name__ == "__main__":
    page = 1
    url = f'https://playorna.com/codex/followers/?p={page}'
    ...
    codex_classes = []
    with open('temp.dump', 'r', encoding='utf-8') as content, open('followers.json', 'w', encoding='utf-8') as codex:
