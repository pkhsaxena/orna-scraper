...
def parse(content) -> bool:
    ...
    classes = soup.find_all('a', class_='codex-entries-entry')

    for _class in classes:
        details = {}
        details['name'] = _class.contents[1].contents[0]
        details['tier'] = _class.contents[2].contents[0].replace('\u2605', '')
...
if __name__ == "__main__":
    page = 1
    url = f'https://playorna.com/codex/classes/?p={page}'
    ...
    codex_classes = []
    with open('temp.dump', 'r', encoding='utf-8') as content, open('classes.json', 'w', encoding='utf-8') as codex:
